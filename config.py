...
class Config:
    def __init__(self):
        ...
        self.DURATION_LIMIT = int(getenv("DURATION_LIMIT", 999999)) * 60
        ...
        self.SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/messo_network")
        self.SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Anjali_music_support")
        ...
        self.PING_IMG = getenv("PING_IMG", "https://files.catbox.moe/4nl0bp.jpg")
        self.START_IMG = getenv("START_IMG", "https://files.catbox.moe/3yqqgz.jpg")
